  ...
  english: [
    ...
    },
    {
      ...
      card: {
        ...
        how: "①列词族（curious→curiosity→curiously）②记拼写重读 ③默写对比",
    ...
    },
    {
      ...
      card: {
        ...
        rule: "一般疑问：be/do/does提前；反义加not或换反义词；保持句义不变只换表达",
        how: "①看题目要求（一般疑问/反义/同义不变）②对应变换 ③检查句义",
  ...
  math: [
    {
      ...
      card: {
        ...
        how: "①列单项式字母及指数 ②相加得次数 ③对照同类项需字母与指数全等",
        why: "2026-08-03+04 batch Q17 单项式次数（学生把 3a^3 b^6 算成 11 而非 9）、Q15-16 升幂排列 多错；属于 M2 概念清不清的确定性错误",
